...
class NaturalDisasterGame:
    ...
    def play_tnt_run(self):
        ...
        # --- REPARAT: Timpul până când podeaua cade (în cadre). 
        # Înainte era 15 (0.3 secunde). Acum e 75 (1.5 secunde reale pe dificultate Normal)!
        crumble_time = max(40, int(75 * diff_mult)) 
        ...
        for f in range(600):
            ...
            for px, py in list(self.hw.pressed_buttons):
                ...
                if (px, py) in abyss_pixels:
                    ...
                    # (Acest 'if' este siguranța ta anti-dublu-click!)
