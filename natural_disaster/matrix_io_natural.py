# matrix_io_natural.py
import socket
import threading
from Controller_natural import NetworkManager, CONFIG # Importăm configurația JSON direct
from config_natural import *

class MatrixHardware:
    def __init__(self):
        self.net = NetworkManager()
        # Nu mai suprascriem IP-ul și portul. Le va lua automat din matrix_ctrl_config.json!
    ...
    def input_listener(self):
        ...
        # Luăm portul de Receive direct din JSON
        recv_port = CONFIG.get("recv_port", 5000) 
        try: sock.bind(("0.0.0.0", recv_port))
        except: return
